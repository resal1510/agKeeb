    ...
    smoothproducts: function() {
      ...
      s(".sp-loading").hide(), s(".sp-wrap").each(function() {
        if (s(this).addClass("sp-touch"), s("a", this).length > 1) {
          var e, t, p = !!s("a.sp-default", this)[0];
          s(this).append('<div class="sp-large"></div><div class="sp-thumbs sp-tb-active"></div>'), s("a", this).each(function(a) {
            var n = s("img", this).attr("src"),
              i = s(this).attr("href"),
              r = "";
            (0 === a && !p || s(this).hasClass("sp-default")) && (r = ' class="sp-current"', e = i, t = s("img", this)[0].src), s(this).parents(".sp-wrap").find(".sp-thumbs").append('<a href="' + i + '" style="background-image:url(' + n + ')"' + r + "></a>"), s(this).remove()
        ...
        s(this).parents(".sp-wrap").addClass("sp-selected"), s("body").append("<div class='sp-lightbox' data-currenteq='" + a + "'>" + t + "</div>"), p > 1 && (s(".sp-lightbox").append("<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>"), 1 == a ? s("#sp-prev").css("opacity", ".1") : a == p && s("#sp-next").css("opacity", ".1")), s(".sp-lightbox").fadeIn(), e.preventDefault()
      }), s(document.body).on("click", ".sp-large a", function(e) {
        var t = s(this).attr("href"),
          p = s(this).parents(".sp-wrap").find(".sp-thumbs a").length,
          a = s(this).parents(".sp-wrap").find(".sp-thumbs .sp-current").index() + 1;
        s(this).parents(".sp-wrap").addClass("sp-selected"), s("body").append('<div class="sp-lightbox" data-currenteq="' + a + '"><img src="' + t + '"/></div>'), p > 1 && (s(".sp-lightbox").append("<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>"), 1 == a ? s("#sp-prev").css("opacity", ".1") : a == p && s("#sp-next").css("opacity", ".1")), s(".sp-lightbox").fadeIn(), e.preventDefault()
        ...
        if (p >= a);
          ...
          var n = p + 1,
            ...
            r = t(s(".sp-selected .sp-thumbs").find("a:eq(" + p + ")").css("backgroundImage"));
        ...
        var p;
        if (e.stopPropagation(), 0 >= (p = (p = s(".sp-lightbox").data("currenteq")) - 1));
        else {
          1 == p && s("#sp-prev").css("opacity", ".1");
          var a = p - 1,
            n = s(".sp-selected .sp-thumbs").find("a:eq(" + a + ")").attr("href"),
            i = t(s(".sp-selected .sp-thumbs").find("a:eq(" + a + ")").css("backgroundImage"));

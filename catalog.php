                          ...
                          <div class="d-none d-md-block">
                              <div class="filters">
                                  <div class="filter-item">
                                      <h3>Filtrer par:</h3><select class="custom-select"><option value="12" selected>This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></select></div>
                              </div>
                          </div>

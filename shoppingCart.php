          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-12 col-lg-4">
              <div class="summary">
                ...
                <h4><span class="text">Total</span><span class="price">CHF <span id="totaloftotal"></span></span></h4><button class="btn btn-primary btn-block btn-lg shadow-sm border-0" type="button" style="background-color: #71c3ff;">Passer en
                  caisse</button>
              </div>
            </div>
          </div>
